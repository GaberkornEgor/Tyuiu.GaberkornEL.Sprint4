using Tyuiu.GaberkornEL.Sprint4.Task2.V21.Lib;

namespace Tyuiu.GaberkornEL.Sprint4.Task2.V21
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Габеркорн Егор Леонидович | АСОиУб - 25 - 1";
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* Спринт #4");
            Console.WriteLine("* Тема: Одномернные массивы");
            Console.WriteLine("* Задание #2");
            Console.WriteLine("* Вариант #21");
            Console.WriteLine("* Габеркорн Егор Леонидович | АСОиУб - 25 - 1                                ");
            Console.WriteLine("***************************************************************************");
